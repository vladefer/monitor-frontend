...
export default function NavegacionLateral({ expanded = false }) {
   ...
   return (
      <div className={`h-screen transition-all duration-300 ease-in-out ${expanded ? "w-[18rem]" : "w-[5rem]"} overflow-hidden rounded-2xl bg-white/100 backdrop-blur-md border border-black/5 shadow-sm`}
         ...
         <nav className="flex flex-col justify-between h-full py-4">
            <div>
               ...
               <div className="flex items-center justify-center py-0">
                  <img className="w-16" src="/img/logo-marca.png" alt="Logo"/>
               </div>
               ...
               {items
                  ...
                  .map((item, i) =>
                     item.separator ? (
                        ...
                        >
                           <i className={`${item.icon} flex-shrink-0`} style={{ fontSize: "1.3rem" }}/>
